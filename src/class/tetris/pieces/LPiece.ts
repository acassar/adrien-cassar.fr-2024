...
export class LPiece extends Piece {
	...
	constructor(gridSize: GridSize) {
		...
		super([new PieceBlock(pieceOrigin, color), new PieceBlock(pieceOrigin + 1, color), new PieceBlock(pieceOrigin + 2, color), new PieceBlock(pieceOrigin + gridSize.x, color)], gridSize);
	}
}